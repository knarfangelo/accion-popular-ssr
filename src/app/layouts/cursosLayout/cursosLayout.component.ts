...
@Component({
  ...
  <header>
    ...
    <p class="descripcion">El curso "Doctrina de Acción Popular", a cargo de Luis Enrrique Gálvez, aborda los principios fundacionales del partido, sus valores democráticos y el legado de Fernando Belaúnde Terry, formando a los participantes en la visión histórica y política de Acción Popular.</p>
    </main>
  </header> 
